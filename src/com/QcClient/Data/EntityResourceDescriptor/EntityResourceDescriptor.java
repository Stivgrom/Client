...
@Root
@Attribute
public class EntityResourceDescriptor extends Serializer<EntityResourceDescriptor>{
    
    public EntityResourceDescriptor(Class<EntityResourceDescriptor> typeParameterClass) {
